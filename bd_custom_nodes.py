...
class bd_Settings:
    ...
    def randomize_it(cfg, steps, variation_amount, denoise, seed, refiner_amount, control_net_strength, custom_01, custom_02, custom_03):
        ...
        if StaticLibrary.almostEqual(variation_amount, 0):
            ...
            print(f"bd settings: no variation amount supplied, using supplied values seed is {seed} cfg is {cfg} and random step amount is {steps}, denoise amt is {denoise}, refiner start is {refiner_start}, custom_01 is {custom_01}, custom_02 is {custom_02}, custom_03 is {custom_03}")
